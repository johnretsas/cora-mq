...
func TestEnqueue() {
	...
	fmt.Printf("\033[32m- Less than 5ms: %d\033[0m\n", requestTimes.lessThan5ms)
	fmt.Printf("\033[32m- Less than 10ms: %d\033[0m\n", requestTimes.lessThan10ms)
	fmt.Printf("\033[32m- Less than 50ms: %d\033[0m\n", requestTimes.lessThan50ms)
	fmt.Printf("\033[32m- Less than 100ms: %d\033[0m\n", requestTimes.lessThan100ms)
	fmt.Printf("\033[32m- Less than 500ms: %d\033[0m\n", requestTimes.lessThan500ms)
	fmt.Printf("\033[32m- Less than 1s: %d\033[0m\n", requestTimes.lessThan1s)
	fmt.Printf("\033[32m- Less than 5s: %d\033[0m\n", requestTimes.lessThan5s)
	fmt.Printf("\033[32m- Greater than 5s: %d\033[0m\n", requestTimes.greaterThan5s)

	if requestTimes.failedRequests > 0 {
		fmt.Printf("\033[31mFailed requests: %d\033[0m\n", requestTimes.failedRequests)
	} else {
		fmt.Printf("\033[34mFailed requests: %d\033[0m\n", requestTimes.failedRequests)
	}
}
